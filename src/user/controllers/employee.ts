...
import EmployeeService, { JwtPasswordResetPayload } from "@/user/services/employee";
import { EmployeePasswordValidator } from "@/user/validators/employee";
...
class EmployeeController {
    ...
    static async create(req: Request, res: Response) {
        try {
            const saved = await EmployeeService.save(req.body, req.user as RequestUser);

            console.log(EmployeeService.create_password_reset_token(saved.id));
            // TODO: Enviar email com link para criação de senha
